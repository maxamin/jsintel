...
|---:|---|---:|---|---|---:|---:|
| 1 | shop.vuln.lab | 1241 | critical | critical 4, high 4, medium 60, low 5 | 15 | 5 |
| 2 | dvwa.vuln.lab | 26 | none | — | 0 | 5 |
| 3 | goat.vuln.lab | 26 | none | — | 0 | 5 |

## shop.vuln.lab — risk 1241 (critical)

- Score: findings 1175 + endpoints 40 + exposure 26
- Services:
  - http://shop.vuln.lab:80/ (200)
  - http://shop.vuln.lab:3000/ (200) — OWASP Juice Shop ⚠ non-standard port
  - http://shop.vuln.lab:8081/ (200) — Login :: Damn Vulnerable Web Application (DVWA) ⚠ non-standard port
  - http://shop.vuln.lab:8082/ (404) ⚠ non-standard port
  - http://shop.vuln.lab:9090/ (404) ⚠ non-standard port
- Top findings:
...
## dvwa.vuln.lab — risk 26 (none)

- Score: findings 0 + endpoints 0 + exposure 26
- Services:
  - http://dvwa.vuln.lab:80/ (200)
  - http://dvwa.vuln.lab:3000/ (200) — OWASP Juice Shop ⚠ non-standard port
  - http://dvwa.vuln.lab:8081/ (200) — Login :: Damn Vulnerable Web Application (DVWA) ⚠ non-standard port
  - http://dvwa.vuln.lab:8082/ (404) ⚠ non-standard port
  - http://dvwa.vuln.lab:9090/ (404) ⚠ non-standard port

## goat.vuln.lab — risk 26 (none)

- Score: findings 0 + endpoints 0 + exposure 26
- Services:
  - http://goat.vuln.lab:80/ (200)
  - http://goat.vuln.lab:3000/ (200) — OWASP Juice Shop ⚠ non-standard port
  - http://goat.vuln.lab:8081/ (200) — Login :: Damn Vulnerable Web Application (DVWA) ⚠ non-standard port
